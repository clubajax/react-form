  ...
  _createClass(List, [{
    ...
    value: function connect() {
      ...
      this.keyHandle = on_default()(this.node, 'keyup', function (e) {
        var focusValue = _this4.state.focusValue;
        var node;
        var index = focusValue === null ? -1 : _this4.props.options.findIndex(function (item) {
...
function (_React$Component) {
  ...
  Popup_createClass(Popup, [{
    ...
    value: function componentDidMount() {
      ...
      this.keyMainHandle = on_default()(buttonId, 'keyup', function (e) {
        switch (e.key) {
          case 'Enter':
          case 'ArrowDown':
            _this2.open();
    ...
    value: function onChange(value) {
      ...
      if (this.props.onChange) {
        if (this.props.name) {
          ...
          var keyValue = (_keyValue = {}, _defineProperty(_keyValue, this.props.name, value), _defineProperty(_keyValue, "name", this.props.name), _defineProperty(_keyValue, "value", value), _defineProperty(_keyValue, "target", this.node), _keyValue);
...
function (_React$Component) {
  ...
  function Checkbox(props) {
    ...
    _this.state = {
      value: _this.uncontrolled ? props.value : props.defaultValue,
      labelId: props.label ? uid_default()('label') : null
    };
  ...
  Checkbox_createClass(Checkbox, [{
    ...
    key: "render",
    value: function render() {
      var checked = this.uncontrolled ? this.state.value : this.props.value;
      var _this$props = this.props,
