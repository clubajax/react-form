...
// CONCATENATED MODULE: ./src/lib/labelHelper.js



var labelHelper_labelHelper = function labelHelper(props, type) {
  var labelId = props.label ? uid_default()('label') : null;
  var inputId = props.label ? props.id || uid_default()(type) : null;
  var labelNode = !props.label ? null : external_react_default.a.createElement("label", {
    id: labelId,
    htmlFor: inputId,
...
/* harmony default export */ var lib_labelHelper = (labelHelper_labelHelper);
// EXTERNAL MODULE: ./node_modules/timers-browserify/main.js
var timers_browserify_main = __webpack_require__(6);
...
var ARIA_ITEM_PREFIX = 'react-item-';
var SEARCH_TIMEOUT = 300; // TODO: search key
...
function (_React$Component) {
  ...
  function List(props) {
    ...
    _this.helper = lib_labelHelper(props, 'list');
  ...
  _createClass(List, [{
    ...
    value: function connect() {
      ...
      var searchNode = function searchNode(key) {
        Object(timers_browserify_main["clearTimeout"])(searchTimer);
        searchTimer = setTimeout(function () {
          searchKeys = '';
        }, SEARCH_TIMEOUT);
        searchKeys = (searchKeys + key).toLowerCase();
        var searchIndex = options.findIndex(function (opt) {
          return opt.label.toLowerCase().indexOf(searchKeys) === 0;
        });
      ...
      this.keyHandle = on_default()(this.node, 'keydown', function (e) {
        ...
        switch (e.key) {
          ...
          default:
            if (on_default.a.isAlphaNumeric(e.key)) {
    ...
    value: function renderList() {
      ...
      var _this$helper = this.helper,
          labelId = _this$helper.labelId,
          inputId = _this$helper.inputId;
    ...
    value: function render() {
      var labelNode = this.helper.labelNode;
...
function (_React$Component) {
  ...
  function Dropdown(props) {
    ...
    _this.helper = lib_labelHelper(props, 'dropdown');
  ...
  Dropdown_createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var _this$helper = this.helper,
          labelNode = _this$helper.labelNode,
          labelId = _this$helper.labelId,
          inputId = _this$helper.inputId;
      ...
      return external_react_default.a.createElement("div", {
        className: classname,
        disabled: disabled
      }, labelNode, external_react_default.a.createElement("div", {
        className: "react-popup-container",
        value: value,
        ref: this.onNode
      }, external_react_default.a.createElement("button", {
        id: inputId // aria-labelledby={labelId}
        ,
...
function (_React$Component) {
  ...
  function Checkbox(props) {
    ...
    _this.helper = lib_labelHelper(props, 'checkbox');
